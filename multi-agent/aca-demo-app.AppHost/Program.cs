...
// var chatbotUi = builder.AddContainer("chatbot-ui2", "ghcr.io/mckaywrigley/chatbot-ui:main")
//     .WithEnvironment("NEXT_PUBLIC_OLLAMA_URL", apiService.GetEndpoint("https") + "/v1")
//     // .WithEnvironment("NEXT_PUBLIC_OPENAI_API_TYPE", "openai")
//     // .WithEnvironment("NEXT_PUBLIC_DEFAULT_MODEL", "phi3")
//     .WithHttpEndpoint(3000, 3000);
